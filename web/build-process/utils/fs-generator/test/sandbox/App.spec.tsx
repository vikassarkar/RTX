...
import { AppComponent } from '../../../ui-toolkit/sandbox/folder-name/AppComponent';

jest.dontMock('../../../ui-toolkit/sandbox/folder-name/AppComponent.tsx');
...
describe('ComponentName', () => {
    ...
    it('ComponentName props should contain TypeScript and React', () => {
        ...
        let widgetName = TestUtils.renderIntoDocument(
            <AppComponent framework={expectedFramework} compiler={expectedCompiler} />
